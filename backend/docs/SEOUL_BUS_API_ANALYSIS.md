...
**전체 URL 예시:**
```
http://ws.bus.go.kr/api/rest/stationinfo/getStationByPos?ServiceKey=YOUR_API_KEY_HERE&tmX=127.025000&tmY=37.575000&radius=100&resultType=json
```
...
**전체 URL 예시:**
```
http://ws.bus.go.kr/api/rest/stationinfo/getStationByUid?ServiceKey=YOUR_API_KEY_HERE&arsId=01234&resultType=json
```
